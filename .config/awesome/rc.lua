...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " DEV ", " WEB ", " SYS ", " DOC ", " WORK ", " VBOX ", " MEDIA ", " MISC " }
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey  }, "o",
    function ()
        awful.spawn(string.format("dmenu_run -i -b",
...
awful.spawn.with_shell("feh --bg-fill $HOME/.config/awesome/themes/powerarrow-blue/starwars.jpg")
