...
local color = {}
color.arc_blue = "#5294e2"
color.orange = "#FF4c29"
color.pink = "#A77AC4"
color.arc_gray = "#343F56"
local theme                                     = {}
...
theme.bg_focus                                  = color.arc_blue --#FF79C6"
...
theme.border_focus                              = color.orange --"#F07178"
theme.border_marked                             = "#CC9393"
theme.titlebar_bg_focus                         = color.arc_gray
theme.titlebar_bg_normal                        = color.arc_gray
theme.titlebar_fg_focus                         = color.arc_gray
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 20, bg = color.arc_gray, fg = theme.fg_normal })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            ...
            arrow(color.arc_gray, color.arc_blue),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), color.arc_blue),
            arrow(color.arc_blue, color.arc_gray),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3),color.arc_gray),
            arrow(color.arc_gray, color.arc_blue),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), color.arc_blue),
            arrow(color.arc_blue, color.arc_gray),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), color.arc_gray),
            arrow(color.arc_gray, color.arc_blue),
            wibox.container.background(wibox.container.margin(clock, 4, 8), color.arc_blue),
            arrow(color.arc_blue, "alpha"),
            --]]
            s.mylayoutbox,
        },
    }
